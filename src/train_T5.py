...
parser.add_argument("--output_dir",type=str, default="./model_out/v8/nopretrain",
    help="The output directory where the model predictions and checkpoints will be written.",
)
parser.add_argument("--encoding_dir", type=str, default="./encoding/v8")

parser.add_argument("--train_dataset", type=str, default="./data/v8/train_v8.txt")
# parser.add_argument("--eval_dataset", type=str, default="/home/mbastan/XP/context_home/XP_project/data/v6/test.txt")
...
def prepare_data(filename,input_len):#,output_len):
    ...
    for idd, sent in enumerate(all_samples):
        ...
        try:
            ...
            continue
        # sample = tokenizer.encode_plus(current_sent, add_special_tokens=False)#,pad_to_max_length=True,padding='max_length',\
        ...
        if len(used_input_temp) <1:
            ...
            continue
        # used_inputs =current_input[:(input_len-actual_len-2)]
        ...
        # input_attention_mask = [1] * (2+len(used_inputs)) + EOS_ID+ [0]*(input_len-len(used_inputs)-3)
...
if args.do_train:
        ...
        for ep in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if True:
                    ...
                    # tokenizer.save_vocabulary(ep_path)
