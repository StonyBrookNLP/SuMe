...
parser.add_argument("--generated_path",type=str, default="./generation_out/afterpretrain_600k_4/5")
parser.add_argument("--greedy_file",type=str, default="generated_schemas_greedy.txt")
parser.add_argument("--beam_file",type=str, default="generated_schemas_beam.txt")
...
for i in range(len(generated_lines_beam)):
    ...
    # new_row['True_lbl'] = true_explan[true_end_ind+1:].strip()#[-15:-6]
    true_labels.append(new_row['True_lbl'])#true_explan[-15:-6].strip())
